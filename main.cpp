...
int main() {
    ...
    list list1;
//    list1.tareaOpcional(1234, 1243);
//    list1.evenDigits(34567);
//    list1.number1(613890);
//    cout << "--------"<< endl;
//    list1.number2(612, 389);
//    cout << "--------"<< endl;
//    list1.appendAtStart(1);
//    list1.appendAtStart(2);
//    list1.appendAtStart(3);
    list1.appendAtStart("-");
    list1.appendAtStart("(");
    //list1.deleteAtStart();
    list1.deleteInPos(1);
//    cout << list1.findByElement(3) << endl;
//    cout << list1.findByElAndPos(1, 3) << endl;
//    cout << list1.dataInPosition(1) << endl;

//    cout << list1.numSize(345);
    //list1.tareaOpcional(5632, 8932);
    list1.printList();
